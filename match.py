...
cre = 'DRIVER={ODBC Driver 17 for SQL Server};SERVER=localhost;DATABASE='data base here';UID='uid here';PWD='password here'!'
...
for keys,data in entries.items():
    ...
    if data[1] and data[2]:
        ...
        if len(data[1]) > 50:
            data[1] = data[1][:49]
        cursor.execute("INSERT [dbo].[Learning_Experience] ([Student_ID], [CourseName], [CourseNumber], [Section], [Professor], [Semester], [Year], [TotalHours], [TypeofLearning], [ConfirmedHours], [LiabilityWaiver], [ProjectAgreement], [TimeLog]) VALUES ("+str(data[0])+", N'"+data[1]+"', N'"+data[2]+"', N'1', N'', N'Spring', 2019, "+str(data[7])+", N'', 1, 0, 0, 1)")
        ...
        uwuu.write("INSERT [dbo].[Learning_Experience] ([Student_ID], [CourseName], [CourseNumber], [Section], [Professor], [Semester], [Year], [TotalHours], [TypeofLearning], [ConfirmedHours], [LiabilityWaiver], [ProjectAgreement], [TimeLog]) VALUES ("+str(data[0])+", N'"+data[1]+"', N'"+data[2]+"', N'1', N'', N'Spring', 2019, "+str(data[7])+", N'', 1, 0, 0, 1)"+"\n")
        cursor.commit()
        #cursor.execute
        pass
    else:
